...
static const char dmenufont[]       = "DepartureMono Nerd Font:size=16";
...
static const char *colors[][3]      = {
	/*               fg           bg            border      */
	/*            text left   bg color bar  window inactive   */
	/*            text middle fg color bar  window active */
	[SchemeNorm] = { "#bdae93", "#1d2021", custom_neon },
	// [SchemeNorm] = { "#bdae93", "#313435", custom_neon },
	[SchemeSel]  = { "#bdae93", "#313435", "#bdae93"  },
	// [SchemeSel]  = { "#bdae93", "#1d2021", "#bdae93"  },
